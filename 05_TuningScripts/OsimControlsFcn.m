...
persistent j1
    ...
    B=SimuInfo.ModelParams(1); %beta
    h=SimuInfo.ModelParams(2); %h
    rosc=SimuInfo.ModelParams(3); %r
    tau1=SimuInfo.ModelParams(4);%tau1
    tau2=SimuInfo.ModelParams(5);%tau2
...
%     u(1)=(1e6*ALPHA1*u(1))+.09*d(1)+0*d(2); %ECRL
%     u(2)=(1e6*ALPHA2*u(2))+0*d(1)+.09*d(2); %FCU %validado para quali
%     u(3)=(1e6*ALPHA3*u(3))+.27*d(1)+0*d(2); %PQ
%     u(4)=(1e6*ALPHA4*u(4))+0*d(1)+.27*d(2); %SUP


    u(1)=(1e6*ALPHA1*u(1))+SimuInfo.ModelParams(7)*d(1)+0*d(2); %ECRL
    u(2)=(1e6*ALPHA2*u(2))+0*d(1)+SimuInfo.ModelParams(8)*d(2); %FCU
    u(3)=(1e6*ALPHA3*u(3))+SimuInfo.ModelParams(9)*d(1)+0*d(2); %PQ
    u(4)=(1e6*ALPHA4*u(4))+0*d(1)+SimuInfo.ModelParams(10)*d(2); %SUP
